...
public class ReportCommand : Command
{
  ...
  public new class Handler : ICommandHandler
  {
    ...
    public async Task<int> InvokeAsync(InvocationContext context)
    {
      ...
      var fileRequests = await _processor.GetFileRequests(AppId, fileFields, filesFilter: FilesFilterList);
      ...
      _logger.Information("File info retrieved for {Count} of {Total} files.", fileInfos.Count, fileRequests.Count);
